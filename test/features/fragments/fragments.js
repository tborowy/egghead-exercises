...
var fragments = function (text)
{
    ...
    var mapping = {
        images: element.all.bind(null, by.css('img')),
        titles: element.all.bind(null, by.binding('req.title')),
        input : element.bind(null, by.css('#title')),
        saveButton: element.bind(null, by.css('#save'))
    };
